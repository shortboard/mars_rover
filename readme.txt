NOTE. Could you copy the *_spec.rb files into a spec folder. I tried to maintain the file system but it appears your email doesn't accept tarballs or zip files.
...
to run with a custom file run "ruby FILENAME"
